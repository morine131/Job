...
public class OutputHistoryBeans {
	...
	private String finish_time_hhmm;
	...
	public void setStart_time_hhmm(Time start_time) {
		this.start_time_hhmm = toOutputStr(start_time);
	}
	public String getFinish_time_hhmm() {
		return finish_time_hhmm;
	}
	public void setFinish_time_hhmm(Time finish_time) {
		System.out.println("setFinis_hhhmmの発生");
		this.finish_time_hhmm = toOutputStr(finish_time);
	}
